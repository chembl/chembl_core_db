...
from django.db.backends.oracle.client import DatabaseClient                          # isort:skip
from django.db.backends.oracle.creation import DatabaseCreation                      # isort:skip
from .features import DatabaseFeatures                      # isort:skip
from .introspection import DatabaseIntrospection            # isort:skip
from .operations import DatabaseOperations                  # isort:skip
from django.db.backends.oracle.schema import DatabaseSchemaEditor                    # isort:skip
...
class FormatStylePlaceholderCursor(object):
    ...
    def execute(self, query, params=None):
        ...
        try:
            ...
            end_time = time.clock()
            #print 'Query took %s' % str(timedelta(seconds=end_time - start_time))
            return ret
